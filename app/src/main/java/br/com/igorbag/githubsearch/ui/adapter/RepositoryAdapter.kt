...
class RepositoryAdapter(private var repositories: List<Repository>): RecyclerView.Adapter<RepositoryAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.repositoryName.text = repositories[position].name
         ...
         holder.shareRepository.setOnClickListener{
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val shareRepository: ImageView
        init {
            view.apply {
                repositoryName = findViewById(R.id.tv_repository_name)
                shareRepository = findViewById(R.id.iv_share)
            }
        }
    }
}
